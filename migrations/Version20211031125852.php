 ...
 */
final class Version20211031125852 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE comment CHANGE parentpost_id parentpost_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE comment DROP FOREIGN KEY FK_9474526C5BB66C05');
        $this->addSql('ALTER TABLE comment CHANGE parentpost_id parentpost_id INT DEFAULT NULL');
